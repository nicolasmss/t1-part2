            ...
            while (serv >= 1) { // checar saida1 é menor tempo
                ...
                if (tempoI + tempo > tempoS &&
                    ...
                    if (eventos2.size() == 0) { // primeiro evento2
                        Evento evento = new Evento(tempo, saidas.get(0).demora, fila2, "chegada", f2capFila,
                                saidas.get(0).demora);
                        evento.temposX[fila2] += tempo;
                        ...
                        for (int j = 0; j < evento.temposX.length; j++) {
                            ...
                            if (fila2 == j) {
                                evento.temposX[j] += saidas.get(0).demora;
                            }
                        }
                    }
                    if (fila2 < f2capFila) {
            ...
            while (serv2 >= 1) { // checar saida2 é menor tempo
                ...
                if (tempoI + tempo > tempoS &&
                    ...
                    for (int j = 0; j < saidas2.get(0).temposX.length; j++) {
                        ...
                        if (fila == j) {
                            saidas2.get(0).temposX[j] += saidas2.get(0).tempo - eventos2.get(eventos.size() - 1).tempo;
                        }
                    }
                    eventos2.add(saidas.get(0));
